...
class GameController extends Controller
{
    ...
    public function game($game_slug){
        $game = Game::where('slug', $game_slug)->with(['cover', 'platforms', 'websites', 'genres', 'collection', 'dlcs', 'dlcs.cover', 'dlcs.platforms', 'dlcs.genres', 'expansions', 'expansions.cover', 'expansions.platforms', 'expansions.genres', 'parent_game', 'videos', 'screenshots', 'involved_companies', 'involved_companies.company', 'multiplayer_modes'])->get()->first();
